...
// Modified by Grange Simpson September 2021
...
namespace SS
{
    ...
    {
        // Don't need anything here, since extends exception.
    }
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// 
        ///  Recursively goes down each of start's depeendees and their dependees.
        ///  If while going down each branch, start is found to be equal to n then there
